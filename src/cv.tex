...
\hypersetup{
  ...
  urlcolor = black,
  pdfauthor = {\name: \name},
  pdfkeywords = {David, Richards, software, developer},
...
\begin{minipage}{1.0\textwidth}
  ...
  \break
  \href{https://dcrichards.com/}{\faicon{globe} dcrichards.com }
  \href{https://github.com/DCRichards}{\faicon{github} DCRichards} 
\end{minipage}
